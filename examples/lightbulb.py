...
class Lightbulb(Accessory):
	...
	def __init__(self, **kwargs):
		...
		self.service = Service(name=kwargs.get("name","Lightbulb"), serviceUuid=Service.UUID_LIGHTBULB)
		...
		self.service.addCharact(self.brightness)
		...
		self.service.addCharact(self.saturation)
		...
		self.service.addCharact(self.hue)

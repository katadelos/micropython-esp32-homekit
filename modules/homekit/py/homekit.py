...
class Homekit:
	...
	@staticmethod
	def add_bridged_accessory(accessory, accessory_name):
		""" Add bridged accessory to homekit data base """
		import homekit_
		homekit_.add_bridged_accessory(accessory.accessory, accessory_name)
